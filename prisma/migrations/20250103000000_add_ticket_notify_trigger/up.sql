...
CREATE TRIGGER ticket_changes_trigger
  AFTER
INSERT OR
UPDATE OR DELETE ON tickets
  FOR EACH ROW
EXECUTE FUNCTION notify_ticket_changes
();

-- Comentário explicativo
COMMENT ON FUNCTION notify_ticket_changes
() IS 'Notifica mudanças na tabela tickets via PostgreSQL NOTIFY para sistema de tempo real';
